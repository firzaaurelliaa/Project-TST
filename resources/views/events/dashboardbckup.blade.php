...
<body>
    <div class="buttonadd">
        <button onclick="window.location.href='{{ route('events.create') }}'"
            style="background-color: #3E9ADD; border: none; color: white; padding: 10px 16px; border-radius: 6px; cursor: pointer;">
    ...
    <div class="card-container">
        ...
        @foreach($events as $event)
            ...
            <!-- <a href="{{ route('events.detail', ['id' => $event->id]) }}"></a> -->
                @if($event->image)
                ...
                <div class="icon">
                    <a href="{{ route('events.edit', $event->id) }}" class="btn btn-edit"
                        style="color: #348AC9; font-size: 20px;">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            cards.forEach(card => {
                card.addEventListener('click', function () {
                    ...
                    window.location.href = "{{ route('events.detail', $event->id) }}";
                });
            });
        });
